...
trait LoadModelTrait
{
     ...
     *
     * @param \yii\db\ActiveRecord|string $class 模型对象
     ...
     */
    protected function loadModel($class, $id, $throwException = true, $config = [])
    {
        if (!class_exists($class)) {
            throw new InvalidConfigException("Model Class `{$class}` does not exists");
        }
