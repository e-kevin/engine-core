...
class Module extends BaseExtensionModel implements ModuleModelInterface
{
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'bootstrap' => Yii::t('ec/extension', 'Bootstrap'),
        ]);
    }
    ...
    public function attributeHints()
    {
        return array_merge(parent::attributeHints(), [
            'bootstrap' => Yii::t('ec/extension', 'When bootstrap is enabled, the current module will automatically load the bootstrap program after the application starts.'),
        ]);
    }
