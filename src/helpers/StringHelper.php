...
use EngineCore\enums\EnumInterface;
use Yii;
...
class StringHelper
{
     ...
     * @return string
     */
    public static function randString($len = 6, $type = EnumInterface::UNLIMITED, $addChars = '')
    {
        $str = '';
        switch ($type) {
            case 0:
     ...
     * @return bool|array
     */
    public static function buildCountRand($number, $length = 4, $type = EnumInterface::UNLIMITED)
    {
    ...
    public static function htmlSubString($str, $length, $url = null, $anchor = '<!-- break -->')
    {
        ...
        if ($url == null) {
            ...
            $replace = '<br />' . Html::a('<i class="glyphicon glyphicon-hand-right"></i>'
                    . Yii::t('app', 'Unfinished,continue reading') . '>>', $url);
